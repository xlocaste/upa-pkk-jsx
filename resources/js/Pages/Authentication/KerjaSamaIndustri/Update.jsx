...
export default function Update({ kerjaSamaIndustri }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Update Kerja Sama Industri" />
            <div className="py-8">
                        ...
                        <div className="p-6 text-gray-900">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex justify-end space-x-4 pt-4">
                                    <SecondaryButton>
                                        <Link href={route('authentication.kerja-sama-industri.index')}>Kembali</Link>
                                    </SecondaryButton>
