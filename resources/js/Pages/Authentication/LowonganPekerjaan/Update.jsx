...
export default function Update({ lowonganKerja }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('authentication.lowongan-pekerjaan.update', lowonganKerja.id));
    };
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div className='flex w h-full space-x-8'>
                                    <div className='w-1/2'>
                                        ...
                                        {errors.judul_lowongan_kerja && (
                                            <div className="text-red-500 text-sm">{errors.judul_lowongan_kerja}</div>
                                        )}
                                    </div>
                                    ...
                                    <div className='w-1/2'>
                                        ...
                                        />
                                        {errors.kontak && (
                                            <div className="text-red-500 text-sm">{errors.kontak}</div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className='flex w h-full space-x-8'>
                                    <div className='w-1/2'>
                                        ...
                                        />
                                        {errors.deskripsi && (
                                            <div className="text-red-500 text-sm">{errors.deskripsi}</div>
                                        )}
                                    </div>
                                    ...
                                    <div className='w-1/2'>
                                        ...
                                        />
                                        {progress && (
                                            <div className="text-sm text-blue-600 mt-1">Uploading... {progress.percentage}%</div>
                                        )}
