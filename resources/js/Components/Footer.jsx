...
const Footer = () => {
    ...
    return (
        <footer className="w-full p-10 md:px-16 bg-gradient-to-r from-blue-300 via-blue-100 to-white text-gray-800">
            <div className="flex flex-col md:flex-row md:space-x-20 space-y-10 md:space-y-0">
                ...
                <div className="md:w-1/4">
                    ...
                    <div className="space-y-2">
                        <a href="https://www.instagram.com/politekniknegerisambas_/" className="flex items-center text-lg space-x-2 hover:text-blue-500">
                            <FaInstagram />
                            <p>politekniknegerisambas_</p>
                        </a>
                        <a href="https://poltesa.ac.id/" className="flex items-center text-lg space-x-2 hover:text-blue-500">
                            <IoEarthOutline />
                            <p>www.poltesa.ac.id</p>
                        </a>
                        <a href="https://www.facebook.com/politekniknegerisambas" className="flex items-center text-lg space-x-2 hover:text-blue-500">
                            <FaFacebook />
                            <p>politekniknegerisambas</p>
                        </a>
                    </div>
                </div>
                ...
                <div className="md:w-1/3">
                    ...
                    <p className="text-justify mt-4 text-sm">
                        &copy; 2025 Politeknik Negeri Sambas. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
